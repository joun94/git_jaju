...
$('#writeBtn').click(function(){
	...
	}else if($('#member_iden').val() == '' || $('#member_iden2').val() == ''){
		$('#member_idenDiv').css({'color': '#b3130b', 'font-size': '8pt', 'font-weight': 'bold'});
		$('#member_idenDiv').html('주민번호를 입력하세요.');
		$('#member_iden').focus();
