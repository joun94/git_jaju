...
<!-- 히든 값으로 id받아오기 ( 세션 으로 로그인 시 아이디 생성. db가서 키워드 가져 올 때 사용하기 )  -->
	...
	<input type="hidden" id="id" name="id" value="ming">	
	...
	<div id="myKeywordDiv" align="center">
		...
		<table border="1" id="myKeywordTable" cellpadding="5" width="550px" bordercolor="#263343" align="center" frame="hsides" rules="rows">
				<tr class="text">
