...
<form name="myMessageFormForm">
	...
	<table border="1" id="myMessageFormTable" class="myMessageFormTable" bordercolor="#ddd" cellspacing="0" cellpadding="5" align="center" frame="hsides" rules="rows"
		...
		<tr>
			...
			<input type="text" id="message_subject" placeholder="제목 입력" style="width:450px; height:20px;">
			</td>
		</tr>
		...
		<tr>
			...
			<th align="left" >전송일 : <span id="message_date_Span"></span></th>
		</tr>
		...
		<tr>
			<td colspan="3" align="center" class="moveToListTd">
				<button class="sendBtn" id="sendBtn" ><a href="/jaju/mypage/myWrite?pg=1">답장</a></button>
