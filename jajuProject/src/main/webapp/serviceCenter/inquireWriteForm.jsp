...
<script src="../js/inquireWriteForm.js"></script>
...
function add(){
    ...
    tmpHTML = "<input type=file name='img[]' style='width:50%' class=line> <a href=\"javascript:del('"+"tr_"+(tr_num)+"')\"><img src='../image/upadd2.jpg' align=absmiddle></a>";
