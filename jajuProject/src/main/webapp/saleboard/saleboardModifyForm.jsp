...
<tr>
 ...
 <tr>
 	...
 	<td class="saleboardModifyTd">
		<label class="">	 	
  		새상품<input type="radio" class="sale_condition" name="sale_condition" id="new" value="새상품">
  			<span class="ico"></span>
  		</label>
  		<label class="">
  		거의 새것<input type="radio" class="sale_condition" name="sale_condition" id="almostNew" value="거의 새것">
  			<span class="ico"></span>
  		</label>
  		<label class="">
  		사용감있음<input type="radio" class="sale_condition" name="sale_condition" id="used" value="사용감있음">
  			<span class="ico"></span>
  		</label>
  		<label class="">
  		사용감많음<input type="radio" class="sale_condition" name="sale_condition" id="veryused" value="사용감많음">
  			<span class="ico"></span>
  		</label>
