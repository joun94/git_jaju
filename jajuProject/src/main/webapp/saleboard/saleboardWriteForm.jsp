...
<tr>
		 	...
		 	<td class="saleboardWriteTd" colspan="2">
		 		<input class="saleboard_input" type="text" style="width:30%;" name="sale_price" id="sale_price" placeholder="가격을 입력해주세요.">
				 <label class="">  	
				  	&nbsp;&nbsp; 
...
<tr>
 ...
 <tr>
 	...
 	<td class="saleboardWriteTd">
		<label class="">	 	
  		새상품<input type="radio" class="sale_condition" name="sale_condition" value="새상품">
  			<span class="ico"></span>
  		</label>
  		<label class="">
  		거의 새것<input type="radio" class="sale_condition" name="sale_condition" value="거의 새것">
  			<span class="ico"></span>
  		</label>
  		<label class="">
  		사용감있음<input type="radio" class="sale_condition" name="sale_condition" value="사용감있음">
  			<span class="ico"></span>
  		</label>
  		<label class="">
  		사용감많음<input type="radio" class="sale_condition" name="sale_condition" value="사용감많음">
  			<span class="ico"></span>
  		</label>
...
<td class="saleText" name="sale_content" id="sale_content" placeholder="내용을 입력해주세요." style="position: relative; width:100%;">

<textarea name="sale_content" style="width:70%; height:474px; resize: none;" class="editing_area" label="내용"></textarea>
</td>
</tr>
...
$(document).ready(function() {
	var sale_stateDefault = $( '#sale_state' )[0].selectedIndex;
$( '#sale_state' ).change(function() {
	$(this)[0].selectedIndex = sale_stateDefault;
	});
});
