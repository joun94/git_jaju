...
public class MypageServiceImpl implements MypageService{
	...
	public List<MypageDTO> getFollowList(Map<String, String> map) {
		...
		System.out.println("service의 follow controller id넘어오는 지 확인 중"+map.get("id"));
	...
	public MyScrap_Paging myScrap_Paging(String pg) {
		int scrapTotalA= mypageDAO.getScrapTotalA();
		myScrap_Paging.setCurrentPage(Integer.parseInt(pg));
