...
public void makePagingHTML() {
		...
		if(startPage>pageBlock)
			...
			pagingHTML.append("<span id='paging' onclick='mypagePaging("+(startPage-1)+")'>이전</span>");
		...
		if(endPage< totalP)
			...
			pagingHTML.append("<span id='paging' name='back' onclick='mypagePaging("+(endPage+1)+")'>다음</span>");
