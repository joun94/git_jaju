...
public class SaleboardPaging {
	...
	public void makePagingHTML() {
		...
		if(startPage > pageBlock) {
			pagingHTML.append("<span id='paging' onclick='saleboardPaging("+(startPage-1)+")'><strong>[이전]</strong></span>");
		}
		...
		if(endPage < totalP) { 
			pagingHTML.append("<span id='paging' onclick='saleboardPaging("+(endPage+1)+")'><strong>[다음]</strong></span>");
		}
